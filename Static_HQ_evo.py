...
class HQ_p_update:
	...
	def update(self, HQ_Ep, Temp, time_step):
		...
		while t0 < time_step:
			...
			channel, small_dt = self.LBT.sample_channel(p1[0], Temp, 0., 0.) 
